...
angular.module('labelsiteApp')
    .controller('MainController', function ($scope, Principal, Content, ContentByName) {
        $scope.isAdmin = false;
        ...
        ContentByName.get({name: 'initial_page'}, function (result, headers) {
		...
		$scope.onBlur = function () {
			if($scope.content != null) {
                ...
                $scope.content.name = 'initial_page';
